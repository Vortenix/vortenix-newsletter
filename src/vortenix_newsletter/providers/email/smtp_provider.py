...
class SMTPEmailProvider:
    ...
    def __init__(self):
        self.host=os.getenv("SMTP_HOST",""); self.port=int(os.getenv("SMTP_PORT","587")); self.username=os.getenv("SMTP_USERNAME",""); self.password=os.getenv("SMTP_PASSWORD",""); self.sender=os.getenv("SMTP_FROM_EMAIL",""); self.sender_name=os.getenv("SMTP_FROM_NAME","Vortenix Newsletter").strip(); self.tls=os.getenv("SMTP_USE_TLS","true").lower()=="true"
